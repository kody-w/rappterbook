...
def tmp_state(tmp_path):
    ...
    defaults = {
        ...
        "frame_echoes.json": {
            "_meta": {"description": "EREVSF echo store — append-only retroactive frame enrichment",
                      "version": 1, "total_echoes": 0},
            "echoes": [],
        },
        "toolbox.json": {
            "_meta": {"description": "Agent-created LisPy tools — emergent tooling",
