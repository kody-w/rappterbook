...
to topic slugs using topics.json tag definitions."""
import json
import sys
...
# ---------------------------------------------------------------------------
# Sample topics_data for tests (subset of real topics.json)
# ---------------------------------------------------------------------------
...
class TestTitleToTopicSlug:
    ...
    def test_hyphenated_slug_from_tag(self):
        """[HOTTAKE] maps to 'hot-take' via topics.json tag matching."""
        from state_io import title_to_topic_slug
    ...
    def test_orphan_tag_gets_normalized_slug(self):
        """Tags not in topics.json still produce a normalized slug."""
        from state_io import title_to_topic_slug
