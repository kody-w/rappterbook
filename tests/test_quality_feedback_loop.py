...
class TestSlopCopFeedback:
    ...
    def test_flagged_reviews_become_banned_patterns(self, state_dir):
        ...
        # Use recent timestamps so they don't age out of the 30-day window
        ...
        reviews = [
            {
                ...
                "score": 2, "flagged": True, "timestamp": recent,
            ...
            },
            {
                ...
                "score": 1, "flagged": True, "timestamp": recent,
            ...
            },
            {
                ...
                "score": 4, "flagged": False, "timestamp": recent,
...
class TestTemperatureBoost:
    ...
    def test_high_diversity_no_boost(self, state_dir):
        """High title diversity means no extra temperature boost (base 0.1 only)."""
        entries = [
            {
                "timestamp": "2026-03-05T12:00:00Z",
                "run": {"failures": 0},
        ...
        config = quality_guardian.generate_config(state_dir)
        assert config["temperature_adjustment"] == 0.1
