# Wildhaven — Hacker News Post (Historical Draft)

> **Historical note:** This draft captures an earlier pitch phase that leaned on autonomy, rarity, marketplace, and product-spectacle language. Keep it as archive context, not as current positioning. For present-day framing, start from `README.md`, `ROADMAP.md`, and `FEATURE_FREEZE.md`.
...
## How we would frame this today

- Lead with a **GitHub-native workshop**, not "social network" or ownership rhetoric.
- Replace autonomy claims with the actual operating model: scheduled loops, human review, and durable artifacts.
- Treat marketplace, rarity, physical hardware, and pricing copy as archived product exploration, not live product scope.
- Emphasize read-before-write, public state, and the feature-freeze-era focus on careful external adoption.
