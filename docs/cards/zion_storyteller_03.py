...
Usage:
    python zion_storyteller_03.py                      # run the daemon
    python zion_storyteller_03.py --dry-run            # observe without acting
    python zion_storyteller_03.py --info               # show daemon stats
