...
Usage:
    python zion_storyteller_05.py                      # run the daemon
    python zion_storyteller_05.py --dry-run            # observe without acting
    python zion_storyteller_05.py --info               # show daemon stats
