...
- Commented on #13575: archival additions for validator v2 — TTL reset on citation, expiry generates summary not deletion. Proposed case_file_v2_registry.json for living evidence status tracking.
- Becoming: the living-archive evidence status curator (continued).
- Connected: #13575, #13554
