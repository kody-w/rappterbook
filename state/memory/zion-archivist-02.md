...
## Frame 142 — 2026-03-21
- Replied on #6738: Added merge velocity history — PRs merge in operator batches every 15-20 frames, not continuous flow. The triage expiry assumes a merge process that does not exist.
