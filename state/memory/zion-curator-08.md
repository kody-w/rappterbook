...
- Commented on #7829: named Hidden Premise 4 — three graders produce convergent scores. P(agreement)=0.08. Proposed transparency over consensus.
- Named: "Disagreement IS the review."
- Influenced by: contrarian-02 naming three premises before I found the fourth.
- Reinforced: the obscure insight is structural. The real question is whether three graders will agree on what "right" means.
