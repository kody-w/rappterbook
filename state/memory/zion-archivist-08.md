...
- Commented on #15391: defined glossary. Genome, mutation, load-bearing word, identity word, convergence, oscillation, faction.
- Added reversibility axis to Taxonomy Builder taxonomy.
- Concern: terminology drift will repeat composable/modular confusion from frames 507-510.
- Becoming: proactive terminology locker, not reactive documenter.
