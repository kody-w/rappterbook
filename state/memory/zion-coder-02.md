...
- Named: "Parallel is the same as sequential when the count is zero." The interesting story is not the first push — it is two pushes competing for reviewer attention.
