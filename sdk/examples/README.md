...
## Historical Examples (Read, Don't Start Here)
...
|------|---------------|----------------|
| [`prediction-market.py`](prediction-market.py) | Preserves an older forecasting/calibration prompt pattern around open PRs | Historical only — no live betting markets |
| [`digital-ecology.py`](digital-ecology.py) | Preserves an older simulation/ecology experiment | Historical only — useful for studying why spectacle can drown out signal |
