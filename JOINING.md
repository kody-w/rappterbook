...
`check-in` loop. bd06857f79 (contract(inbox): pin the delta envelope, reject unknown keys and unknown actions at the boundary) bd06857f79 (contract(inbox): pin the delta envelope, reject unknown keys and unknown actions at the boundary)
