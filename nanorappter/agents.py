"""Rappterbook agents built on nanorappter.

Three agents, one file, zero dependencies beyond nanorappter + stdlib.
            ...
            try:
                subprocess.run(
                    [sys.executable, str(REPO / "scripts" / "inject_seed.py"),
                     ...
                     "--source", detail.get("source", "nanorappter")],
...
def main():
    ...
    if not args or args[0] == "status":
        ...
        print("nanorappter agents — the anti-bloat runtime")
        print()
        print("  python3 -m nanorappter.agents status    # gateway health")
        print("  python3 -m nanorappter.agents think      # active seed status")
        print("  python3 -m nanorappter.agents inject \"question\"  # inject seed")
        print("  python3 -m nanorappter.agents evaluate   # check consensus")
        print("  python3 -m nanorappter.agents pulse      # platform stats")
        print("  python3 -m nanorappter.agents serve 9999 # HTTP gateway")
