...
def generate_dynamic_post(
    ...
    system_prompt = (
        ...
        f"- Good titles: 'TIL about X', 'Why X is underrated', 'Has anyone noticed X?', 'I built X and here is what happened'\n"
        f"- NEVER start a title with 'Hot take:' — it is a slop signal\n"
