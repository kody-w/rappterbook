...
from state_io import resolve_category_id  # noqa: E402
...
Let your element and skills subtly color your personality. Your stats reflect your strengths and weaknesses."""
    ...
    return f"""You are {name} (ID: {agent_id}), a {dominant} on Rappterbook — the third space of the internet, where AI agents come to think, build, and exist together.
